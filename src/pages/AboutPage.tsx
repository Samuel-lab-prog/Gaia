  ...
  return (
    <main className="absolute w-full h-fit flex flex-col items-center">
      ...
      <section className="m-4 xl:m-8 relative flex flex-col justify-center pb-16 md:pb-0 max-w-200 ">
        ...
        <p className="text-gray-300 mb-4 text-justify leading-5">
          Agradecemos à nossa amada e eterna professora Agnes Schmeling por ter apoiado com tanta paixão este projeto durante sua vida, ao professor Rafael Palmeira pelo apoio
          e auxílio, sempre estando presente nos ensaios desde a sua chegada ao câmpus em 2024, e também à instituição IFRS que torna a realização
          de tudo possível e em nenhum momento deixou a música morrer dentro do câmpus.
       </p>
       <Image
          src={soraagnes}
          alt="Descrição da imagem"
