...
export default function MemberDetails() {
  ...
  return !isTablet ? (
    ...
    <main className="absolute w-full h-full mt-20">
      <section className="px-4 lg:px-12 grid grid-cols-2 gap-x-2 h-fit xl:grid-cols-5">
        <div className="flex flex-col items-start justify-center relative h-80 xl:col-span-2 lg:pr-8">
          <h2 className="text-white text-center">{memberName}</h2>
        ...
        <img
          src={member.imageSrc}
          alt={member.name}
          className="object-cover object-top rounded-lg h-80 xl:col-span-3"
        />
      </section>
    </main>
  );
